...

{
  ...
  println(
    for {                       //NB: brances & no semicolons
      parts <- names            //this is an alternative, and preffered style 
      part <- parts             //for multiple generators  (ie., multiple <- )
     } yield part
  )
...

{
  ...
  // THE TYPE OF A FOR COMPREHENSION

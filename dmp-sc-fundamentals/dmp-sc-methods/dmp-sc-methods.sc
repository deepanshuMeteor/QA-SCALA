...

{
  ...
  println(blocksum(10, 20))
  println(linesum(10, 20))
...

{
  ...
  println("calling notDefined causes an error!")
  // println(notDefined(1, "a", false))
...

{
  ...
  println( ifS(true, fact(5), fact(100))   )  // LONG TIME
  println( ifL(true, fact(5), fact(100))   )  // SHORT TIME
  /*
